...
def main():
    ...
    isEaten_slowpill,generate_slowpill,colordict
    pygame.init()
    ...
    while isGame:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                isGame = False
        mouse_pos = pygame.mouse.get_pos()
        x_pos,y_pos,width,height=480,270,120,60
...
def how_snake_die():
    ...
    while isGame:
        ...
        button('red','pink','restart','white',600,300,120,60,main)
...
def snake_game():
    ...
    delay, tail_length, screen, isGame, isEaten, colordict
